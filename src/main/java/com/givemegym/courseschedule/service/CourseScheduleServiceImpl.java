...
//        }
    ...
    @Override
    public List<CourseSchedule> findCourseScheduleByCourseScheduleDate(Date courseScheduleDate) {
        return coursescheduleDao.findCourseScheduleByCourseScheduleDate(courseScheduleDate);
    }
}
